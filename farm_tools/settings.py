"""
Django settings for farm_tools project.
...
SECRET_KEY = 'django-insecure-u2cm*e8dtl6v1at5xb)#175y$bzu!a*07!psq!7@j=(g&icy-i'
...
WSGI_APPLICATION = 'farm_tools.wsgi.application'
